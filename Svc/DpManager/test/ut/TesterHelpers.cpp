...
namespace Svc {
    ...
    connectPorts()
  {
    ...
    this->connect_to_productRequestIn(
        0,
        this->component.get_productRequestIn_InputPort(0)
    );

    // productSendIn
    this->connect_to_productSendIn(
        0,
        this->component.get_productSendIn_InputPort(0)
    );
    ...
    // bufferGetOut
    this->component.set_bufferGetOut_OutputPort(
        0,
        this->get_from_bufferGetOut(0)
    );
    ...
    // productResponseOut
    this->component.set_productResponseOut_OutputPort(
        0,
        this->get_from_productResponseOut(0)
    );
